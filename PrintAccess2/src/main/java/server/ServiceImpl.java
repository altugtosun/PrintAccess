...
public class ServiceImpl extends UnicastRemoteObject implements Service {
    ...
    public String print(String filename, String printer, User user) throws IOException, NoSuchAlgorithmException {
        ...
        this.logger.info("Authentication and access successful for method: print user: " + user.getUsername());
    ...
    public String queue(User user) throws IOException, NoSuchAlgorithmException {
        ...
        if(!hasAccess(user, "CAN_READ_QUEUE")) {
            this.logger.info("Access failed for method: queue user: " + user.getUsername());
            return "Access failed.";
        }
        this.logger.info("Authentication and access successful for method: queue user: " + user.getUsername());
        String result = "";
    ...
    public String topQueue(int jobId, User user) throws IOException, NoSuchAlgorithmException {
        ...
        if(!hasAccess(user, "CAN_EDIT_QUEUE")) {
            this.logger.info("Access failed for method: topQueue user: " + user.getUsername());
            return "Access failed.";
        }
        this.logger.info("Authentication and access successful for method: topQueue user: " + user.getUsername());
        int position = -1;
    ...
    public String readConfig(String parameter, User user) throws IOException, NoSuchAlgorithmException {
        ...
        if(!hasAccess(user, "CAN_READ_CONFIG")) {
            this.logger.info("Access failed for method: readConfig user: " + user.getUsername());
            return "Access failed.";
        }
        this.logger.info("Authentication and access successful for readConfig: print user: " + user.getUsername());
    ...
    public String setConfig(String parameter, String value, User user) throws IOException, NoSuchAlgorithmException {
        ...
        if(!hasAccess(user, "CAN_WRITE_CONFIG")) {
            this.logger.info("Access failed for method: setConfig user: " + user.getUsername());
            return "Access failed.";
        }
        this.logger.info("Authentication and access successful for method: setConfig user: " + user.getUsername());
    ...
    public String status(User user) throws IOException, NoSuchAlgorithmException {
        ...
        if(!hasAccess(user, "CAN_READ_STATUS")) {
            this.logger.info("Access failed for method: status user: " + user.getUsername());
            return "Access failed.";
        }
        this.logger.info("Authentication and access successful for method: status user: " + user.getUsername());
    ...
    public String start(User user) throws IOException, NoSuchAlgorithmException {
        ...
        if(!hasAccess(user, "CAN_START")) {
            this.logger.info("Access failed for method: start user: " + user.getUsername());
            return "Access failed.";
        }
        this.logger.info("Authentication and access successful for method: start user: " + user.getUsername());
    ...
    public String restart(User user) throws IOException, NoSuchAlgorithmException {
        ...
        if(!hasAccess(user, "CAN_RESTART")) {
            this.logger.info("Access failed for method: restart user: " + user.getUsername());
            return "Access failed.";
        }
        this.logger.info("Authentication and access successful for method: restart user: " + user.getUsername());
    ...
    public String stop(User user) throws IOException, NoSuchAlgorithmException {
        ...
        if(!hasAccess(user, "CAN_STOP")) {
            this.logger.info("Access failed for method: stop user: " + user.getUsername());
            return "Access failed.";
        }
        this.logger.info("Authentication and access successful for method: stop user: " + user.getUsername());
    ...
    public Boolean hasAccess(User user, String access) {
        return SQLiteJDBC.hasAccess(user.getUsername(), access);
    }
}
